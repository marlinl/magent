...
final class MagentErrorTests: XCTestCase {
  ...
  func testErrorEquality() {
    XCTAssertEqual(
      MagentError.cryptoError("bufferTooSmall"), MagentError.cryptoError("bufferTooSmall"))
    XCTAssertNotEqual(
      MagentError.cryptoError("bufferTooSmall"), MagentError.cryptoError("invalidPassword"))
    XCTAssertNotEqual(
